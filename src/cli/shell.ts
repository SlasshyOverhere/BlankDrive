...
function showHelpList(): void {
  ...
  console.log(chalk.gray('  Web UI: ') + chalk.cyan('web --open') + chalk.gray(' | Check CLI updates: ') + chalk.cyan('update --check'));
  ...
  console.log(chalk.cyan('\n  System'));
  console.log(chalk.white('    update [--check|--install|--scheduled]'));
...
`));
  ...
  console.log(chalk.gray('  ─────────────────────────────────────────────────\n'));
  console.log(chalk.gray('  Web UI: ') + chalk.cyan('web --open') + chalk.gray(' | Update check: ') + chalk.cyan('update --check'));
  console.log('');
